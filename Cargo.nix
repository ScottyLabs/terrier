  ...
  internal = rec {
    ...
    crates = {
      ...
      "askama" = rec {
        ...
        version = "0.15.4";
        edition = "2024";
        sha256 = "0msyd77lgh70zhm7vlwk86i81zchfjfr8krpd70zxbbc6imngq88";
        dependencies = [
          {
            name = "askama_macros";
            packageId = "askama_macros";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
        ...
        features = {
          "alloc" = [ "askama_macros?/alloc" "serde?/alloc" "serde_json?/alloc" "percent-encoding?/alloc" ];
          ...
          "std" = [ "alloc" "askama_macros?/std" "serde?/std" "serde_json?/std" "percent-encoding?/std" ];
      ...
      "askama_derive" = rec {
        ...
        version = "0.15.4";
        edition = "2024";
        sha256 = "0drsdw0pa7hzj7wcwj9himycvyi6fh1xnxbg6wzk91vpa5bgyqbn";
        dependencies = [
          {
            name = "askama_parser";
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            features = [ "clone-impls" "derive" "full" "parsing" "printing" ];
          }
        ];
        features = {
          "code-in-doc" = [ "dep:pulldown-cmark" ];
          "config" = [ "external-sources" "dep:basic-toml" "dep:serde" "dep:serde_derive" "parser/config" ];
          "default" = [ "alloc" "code-in-doc" "config" "external-sources" "proc-macro" "serde_json" "std" "urlencode" ];
          "proc-macro" = [ "proc-macro2/proc-macro" ];
          "std" = [ "alloc" ];
        };
        resolvedDefaultFeatures = [ "alloc" "config" "external-sources" "proc-macro" "std" "urlencode" ];
      };
      "askama_macros" = rec {
        crateName = "askama_macros";
        version = "0.15.4";
        edition = "2024";
        sha256 = "0yz4ljcplsrsf5563136av5j27gs05dlcndqvb11kdqyzpdy8gki";
        procMacro = true;
        dependencies = [
          {
            name = "askama_derive";
            packageId = "askama_derive";
            rename = "askama_derive";
            usesDefaultFeatures = false;
        ...
        resolvedDefaultFeatures = [ "alloc" "config" "std" "urlencode" ];
      };
      "askama_parser" = rec {
        crateName = "askama_parser";
        version = "0.15.4";
        edition = "2024";
        sha256 = "0k3hkiivy0svcf6z7rv4i6fxpsjv1m4fy38cncc68lla4dsdcqhx";
        dependencies = [
          {
            name = "rustc-hash";
            packageId = "rustc-hash";
      ...
      "migration" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/terrier-server/migration; };
        dependencies = [
          {
            name = "async-std";
            packageId = "async-std";
      ...
      "samael" = rec {
        ...
        authors = [
          "Nathan Jaremko <nathan@jaremko.ca>"
        ];
        dependencies = [
          {
            name = "base64";
        ...
        resolvedDefaultFeatures = [ "default" "lazy_static" "libc" "libxml" "xmlsec" ];
      };
      "same-file" = rec {
        crateName = "same-file";
        version = "1.0.6";
      ...
      "sea-orm" = rec {
        ...
        resolvedDefaultFeatures = [ "macros" "postgres-array" "runtime-tokio" "runtime-tokio-native-tls" "sea-query-binder" "sqlx" "sqlx-dep" "sqlx-postgres" ];
      };
      "sea-orm-cli" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "dotenvy" "runtime-tokio-native-tls" "sqlx-postgres" "tokio" ];
      };
      "sea-orm-macros" = rec {
      ...
      "sea-orm-migration" = rec {
        ...
        resolvedDefaultFeatures = [ "clap" "cli" "default" "dotenvy" "runtime-tokio-native-tls" "sea-orm-cli" "sqlx-postgres" ];
      };
      "sea-query" = rec {
        crateName = "sea-query";
        version = "0.32.7";
      ...
      "sea-query-binder" = rec {
        ...
        resolvedDefaultFeatures = [ "postgres-array" "runtime-tokio-native-tls" "sqlx" "sqlx-postgres" ];
      };
      ...
      "sea-schema" = rec {
        ...
        resolvedDefaultFeatures = [ "def" "discovery" "futures" "parser" "postgres" "probe" "query" "runtime-tokio-native-tls" "sea-query-binder" "sqlx" "sqlx-dep" "sqlx-postgres" "writer" ];
      };
      ...
      "sqlx" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "postgres" "runtime-tokio" "runtime-tokio-native-tls" "sqlx-postgres" "tls-native-tls" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.8.6";
      ...
      "sqlx-macros" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_tls-native-tls" "default" "postgres" ];
      };
      "sqlx-macros-core" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "_tls-native-tls" "default" "postgres" "sqlx-postgres" "tokio" ];
      };
      "sqlx-postgres" = rec {
      ...
      "terrier-common" = rec {
        crateName = "terrier-common";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/terrier-common; };
        libName = "terrier_common";
        dependencies = [
          {
            name = "tokio";
            packageId = "tokio";
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "cors" "default" "follow-redirect" "fs" "futures-core" "futures-util" "httpdate" "iri-string" "mime" "mime_guess" "percent-encoding" "set-status" "tokio" "tokio-util" "tower" "trace" "tracing" ];
      };
      "tower-layer" = rec {
