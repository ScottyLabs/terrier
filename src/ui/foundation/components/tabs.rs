...
pub fn TabSwitcher<T: Clone + PartialEq + 'static>(
    ...
    rsx! {
        div { class: "inline-flex md:flex flex-col md:flex-row items-center md:justify-center gap-2 p-1 bg-background-neutral-subtle-pressed rounded-xl md:rounded-full",
