...
#[openapi(
    paths(
        ...
        crate::hackathons::handlers::teams::kick_member,
        crate::hackathons::handlers::teams::transfer_ownership,
        crate::hackathons::handlers::teams::leave_team_force,
        crate::hackathons::handlers::teams::get_team_details,
        crate::hackathons::handlers::teams::get_outgoing_join_requests,
        crate::hackathons::handlers::teams::cancel_outgoing_join_request,
    ...
    components(
        schemas(
            ...
            crate::hackathons::handlers::teams::OutgoingJoinRequestResponse,
